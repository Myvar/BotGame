...
namespace DiscordBotGame.Instructions
{
    ...
    public class NorthEastInstruction : Instruction
    {
        public override string Handel(Player p, List<Player> players, Command c)
        {
            ...
            return $"{p.Name} Has Move{(c.Argument == 0 ? "" : "d " + c.Argument + " times")} North East";
        }
    }
}